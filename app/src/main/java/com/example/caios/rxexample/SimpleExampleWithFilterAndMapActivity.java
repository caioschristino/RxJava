 ...
 */
public class SimpleExampleWithFilterAndMapActivity extends RxAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable.just(1, 2, 3, 4, 5, 6) // add more numbers
                ...
                .subscribe(new Subscriber<Object>() { // notice Subscriber type changed to
                    @Override
                    ...
                    public void onNext(Object o) {
                        if (adapter != null) {
                            DummyContentItem.addNewItem(Double.parseDouble(String.valueOf(o)));
